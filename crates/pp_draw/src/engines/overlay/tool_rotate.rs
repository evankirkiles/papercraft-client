use crate::cache::tool::rotate::RotateToolGPU;
use crate::gpu;

#[derive(Debug)]
pub struct ToolRotateProgram {
    pipeline: wgpu::RenderPipeline,
}

impl ToolRotateProgram {
    pub(super) fn new(ctx: &gpu::Context) -> Self {
        let shader =
            ctx.device.create_shader_module(wgpu::include_wgsl!("./shaders/tool_rotate.wgsl"));
        Self {
